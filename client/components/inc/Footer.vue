            ...
            <div class="row">
                  ...
                  <div class="col-md-12 col-sm-6">
                    ...
                    <div class="widget">
                      ...
                      <div class="widget-content">
                        ...
                        <p>Mail:
                          <a href="http://envato.megadrupal.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="fb93948894899e95bb9c969a9297d5989496">[email&#160;protected]</a>
                        </p>
                      </div>
                    </div>
                    <!-- /.widget -->
              ...
              <div class="col-md-2 col-sm-6">
                ...
                <div class="widget">
                  ...
                  <ul>
                    <li>
                      <a href="#" title="">Your Cart</a>
                    </li>
                    <li>
                      <a href="#" title="">Your Orders</a>
                    </li>
                    <li>
                      <a href="#" title="">Compared Items</a>
                    </li>
                    <li>
                      <a href="#" title="">Wishlist Items</a>
                    </li>
                    <li>
                      <a href="#" title="">Shipping Detail</a>
                    </li>
                  </ul>
                </div>
                <!-- /.widget -->
              ...
              <div class="col-md-2 col-sm-6">
                ...
                <div class="widget">
                  ...
                  <ul>
                    ...
                    <li>
                      <a href="#" title="">Gift Center</a>
                    </li>
                    <li>
                      <a href="#" title="">Buying Guides</a>
                    </li>
                    <li>
                      <a href="#" title="">New Arrivals</a>
                    </li>
                    <li>
                      <a href="#" title="">Clearance</a>
                    </li>
                  </ul>
                </div>
                <!-- /.widget -->
